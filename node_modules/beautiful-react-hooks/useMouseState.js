...
var useMouseState = function (targetRef) {
    ...
    var _a = react_1.useState({ clientX: 0, clientY: 0, screenX: 0, screenY: 0 }), state = _a[0], setState = _a[1];
    var onMouseMove = useMouseEvents_1.default(targetRef).onMouseMove;
