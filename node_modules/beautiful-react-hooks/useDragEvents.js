...
var useDragEvents = function (targetRef, setDraggable) {
    ...
    var _a = useHandlerSetterRef_1.default(), onDrag = _a[0], setOnDrag = _a[1];
    var _b = useHandlerSetterRef_1.default(), onDrop = _b[0], setOnDrop = _b[1];
    var _c = useHandlerSetterRef_1.default(), onDragEnter = _c[0], setOnDragEnter = _c[1];
    var _d = useHandlerSetterRef_1.default(), onDragEnd = _d[0], setOnDragEnd = _d[1];
    var _e = useHandlerSetterRef_1.default(), onDragExit = _e[0], setOnDragExit = _e[1];
    var _f = useHandlerSetterRef_1.default(), onDragLeave = _f[0], setOnDragLeave = _f[1];
    var _g = useHandlerSetterRef_1.default(), onDragOver = _g[0], setOnDragOver = _g[1];
    var _h = useHandlerSetterRef_1.default(), onDragStart = _h[0], setOnDragStart = _h[1];
    if (targetRef !== null && !safeHasOwnProperty_1.default(targetRef, 'current')) {
        return createCbSetterErrorProxy_1.default('Unable to assign any drag event to the given ref');
    }
    react_1.useEffect(function () {
