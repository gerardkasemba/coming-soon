 ...
 * viewport.
 */
var useViewportSpy = function (elementRef, options) {
    if (options === void 0) { options = defaultOptions; }
    if (!isClient_1.default || !isAPISupported_1.default('IntersectionObserver')) {
    ...
    var _a = react_1.useState(), isVisible = _a[0], setIsVisible = _a[1];
