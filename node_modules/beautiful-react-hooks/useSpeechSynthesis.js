...
var defaultOptions = { rate: 0, pitch: 0, volume: 1 };
/**
...
var useSpeechSynthesis = function (text, options) {
    ...
    var utter = react_1.useMemo(function () { return new SpeechSynthesisUtterance(text); }, [text]);
    ...
    var speak = react_1.useCallback(function () { return speechSynthesis.speak(utter); }, [text, voiceOptions.pitch, voiceOptions.rate, voiceOptions.voice, voiceOptions.volume]);
    return {
        speak: speak,
