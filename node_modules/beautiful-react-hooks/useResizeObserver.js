...
var useResizeObserver = function (elementRef, debounceTimeout) {
    ...
    var isSupported = isAPISupported_1.default('ResizeObserver');
    var observerRef = react_1.useRef(null);
    var _a = react_1.useState(), DOMRect = _a[0], setDOMRect = _a[1];
    ...
    react_1.useEffect(function () {
        if (isSupported) {
            var fn_1 = lodash_debounce_1.default(function (entries) {
