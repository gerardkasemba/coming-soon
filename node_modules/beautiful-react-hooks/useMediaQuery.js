...
var useMediaQuery = function (mediaQuery) {
    if (!isClient_1.default || !isAPISupported_1.default('matchMedia')) {
        // eslint-disable-next-line no-console
        console.warn(errorMessage);
        return null;
    }
    var _a = react_1.useState(!!window.matchMedia(mediaQuery).matches), isVerified = _a[0], setIsVerified = _a[1];
    react_1.useEffect(function () {
        var mediaQueryList = window.matchMedia(mediaQuery);
        var documentChangeHandler = function () { return setIsVerified(!!mediaQueryList.matches); };
        try {
