...
var useRequestAnimationFrame = function (func, options) {
    ...
    if (!isClient_1.default || !isAPISupported_1.default('requestAnimationFrame')) {
        // eslint-disable-next-line no-console
        console.warn(errorMessage);
        return createCbSetterErrorProxy_1.default(errorMessage);
    }
    var opts = __assign(__assign({}, defaultOptions), options);
    var progress = react_1.useRef(opts.startAt);
    var _a = useHandlerSetterRef_1.default(), onFinish = _a[0], setOnFinish = _a[1];
    // eslint-disable-next-line @typescript-eslint/no-use-before-define
    var next = function () { return window.requestAnimationFrame(step); };
    var step = react_1.useCallback(function () {
