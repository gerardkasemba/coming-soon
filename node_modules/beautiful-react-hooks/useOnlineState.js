...
var useOnlineState = function () {
    ...
    var _a = react_1.useState(isSupported ? navigator.onLine : true), isOnline = _a[0], setIsOnline = _a[1];
    var whenOnline = useGlobalEvent_1.default('online', undefined, { capture: true });
    var whenOffline = useGlobalEvent_1.default('offline', undefined, { capture: true });
    if (!isSupported) {
