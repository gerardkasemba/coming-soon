...
var useTouchEvents = function (targetRef) {
    ...
    var _a = useHandlerSetterRef_1.default(), onTouchStartHandler = _a[0], setOnTouchStartHandler = _a[1];
    var _b = useHandlerSetterRef_1.default(), onTouchEndHandler = _b[0], setOnTouchEndHandler = _b[1];
    var _c = useHandlerSetterRef_1.default(), onTouchCancelHandler = _c[0], setOnTouchCancelHandler = _c[1];
    var _d = useHandlerSetterRef_1.default(), onTouchMoveHandler = _d[0], setOnTouchMoveHandler = _d[1];
    if (targetRef !== null && !safeHasOwnProperty_1.default(targetRef, 'current')) {
        return createCbSetterErrorProxy_1.default('Unable to assign any touch event to the given ref');
    }
    assignEventOnMount_1.default(targetRef, onTouchStartHandler, 'touchstart');
    assignEventOnMount_1.default(targetRef, onTouchEndHandler, 'touchend');
    assignEventOnMount_1.default(targetRef, onTouchCancelHandler, 'touchcancel');
    assignEventOnMount_1.default(targetRef, onTouchMoveHandler, 'touchmove');
