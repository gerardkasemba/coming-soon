...
var useGeolocationEvents = function (options) {
    ...
    var watchId = react_1.useRef();
    var _a = useHandlerSetterRef_1.default(), onChangeRef = _a[0], setOnChangeRef = _a[1];
    var _b = useHandlerSetterRef_1.default(), onErrorRef = _b[0], setOnErrorRef = _b[1];
    ...
    return !isSupported ? createCbSetterErrorProxy_1.default('The Geolocation API is not supported') : Object.freeze({
