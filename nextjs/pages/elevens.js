      ...
      <React.Fragment>
        ...
        <div className="fullWrapper">
          <MainWrapper style={{height: 'auto'}}>
            <Container className="mainContainer" style={{height: 400, paddingTop: 200}}>
              <MainContentSection>
                <LogoImageContainer style={{float: 'left', clear: 'both', textAlign: 'left'}}>
                  <Link href={'/twelve'}>
                    <a>
            ...
            {/* <FooterSection style={{height: '200px'}}>
